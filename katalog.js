...
const lastReadBooks = document.getElementById("last-read-books");
...
lastReadBooks.innerHTML = books 
    .slice(0, 5) 
    .map((book, index) => ` 
        <div class="group relative flex h-[120px] w-[295px] shrink-0 items-center rounded-[16px] px-4 pl-[115px]" style="background-color: ${lastReadColors[index % lastReadColors.length]};"> 
